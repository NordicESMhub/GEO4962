...
<pre>ssh -Y $LOGNAME@cruncher.norstore.uio.no
</pre>
...
Please note that these machines are not accessible outside the UIO networks. If you wish to login on abel or cruncher outside the UIO network, use [X2Go Client](http://www.mn.uio.no/geo/english/services/it/help/using-linux/x2go.html).  
The source code we will be using is stored in /projects/NS1000K/GEF4530/cesm1_2_2/models/atm/cam:`

<pre>cd /projects/NS1000K/GEF4530/cesm1_2_2/models/atm/cam
ls 
</pre>
